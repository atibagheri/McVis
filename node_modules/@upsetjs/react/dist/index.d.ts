...
interface UpSetElementProps<T, C, N> extends UpSetBaseElementProps<C, N> {
    /**
...
interface VennDiagramElementProps<C, N> extends UpSetBaseElementProps<C, N> {
    /**
     * object of classnames for certain sub elements
     */
...
interface KarnaughMapElementProps<C, N> extends UpSetBaseElementProps<C, N> {
    /**
     * object of classnames for certain sub elements
     */
...
interface VennDiagramPropsG<T, C, N, L> extends VennDiagramDataProps<T>, VennDiagramLayoutProps, VennDiagramStyleProps<L>, VennDiagramThemeProps, VennDiagramElementProps<C, N>, UpSetSelectionProps<T> {
    children?: N;
}
declare type VennDiagramProps<T = any> = VennDiagramPropsG<T, React.CSSProperties, React.ReactNode, React.ReactNode>;
interface VennDiagramFullPropsG<T, C, N, L> extends Required<Omit<VennDiagramDataProps<T>, 'toElemKey'>>, Required<VennDiagramLayoutProps>, Required<VennDiagramStyleProps<L>>, Required<VennDiagramThemeProps>, Required<VennDiagramElementProps<C, N>>, UpSetSelectionProps<T> {
    toElemKey?: (elem: T) => string;
    children?: N;
}
declare type VennDiagramFullProps<T = any> = VennDiagramFullPropsG<T, React.CSSProperties, React.ReactNode, React.ReactNode>;
interface KarnaughMapPropsG<T, C, N, L> extends KarnaughMapDataProps<T>, KarnaughMapLayoutProps, KarnaughMapStyleProps<L>, KarnaughMapThemeProps, KarnaughMapElementProps<C, N>, UpSetSelectionProps<T> {
    children?: N;
}
declare type KarnaughMapProps<T = any> = KarnaughMapPropsG<T, React.CSSProperties, React.ReactNode, React.ReactNode>;
interface KarnaughMapFullPropsG<T, C, N, L> extends Required<Omit<KarnaughMapDataProps<T>, 'toElemKey'>>, Required<KarnaughMapLayoutProps>, Required<KarnaughMapStyleProps<L>>, Required<KarnaughMapThemeProps>, Required<KarnaughMapElementProps<C, N>>, UpSetSelectionProps<T> {
    toElemKey?: (elem: T) => string;
    children?: N;
}
...
declare const _default$2: <T>(p: UpSetProps<T> & React.RefAttributes<SVGSVGElement>) => React.ReactElement;
...
declare const _default: <T>(p: KarnaughMapProps<T> & React.RefAttributes<SVGSVGElement>) => React.ReactElement;
...
declare function setLabelOffsets(value?: VennDiagramLayoutProps['setLabelOffsets']): boolean;
...
declare const validators_setLabelOffsets: typeof setLabelOffsets;
...
declare namespace validators {
  export {
    ...
    validators_setLabelOffsets as setLabelOffsets,
