...
var model = require('@upsetjs/model');
...
function styleFactory(rules) {
    return React__default["default"].createElement("style", null, rules);
}
...
function exportDumpData(props, data, compress = false, mode) {
    ...
    const dump = model.toDump({
        sets: props.sets,
        queries: (_b = (_a = props.queries) === null || _a === void 0 ? void 0 : _a.filter((d) => model.isElemQuery(d) || model.isSetQuery(d))) !== null && _b !== void 0 ? _b : [],
        toElemIndex,
        selection: props.selection && model.isSetLike(props.selection) ? props.selection : undefined,
...
function exportSharedLink(props, data, mode) {
    ...
    delete r.$schema;
    const arg = LZString__default["default"].compressToEncodedURIComponent(JSON.stringify(r));
    ...
    delete r2.$schema;
    const arg2 = LZString__default["default"].compressToEncodedURIComponent(JSON.stringify(r2));
...
function elemOverlapOf(query, toElemKey) {
    const f = model.setOverlapFactory(query, toElemKey);
    return (s) => {
...
function elemElemOverlapOf(query, toElemKey) {
    const f = model.setElemOverlapFactory(query, toElemKey);
    return (s) => {
        return f(s.elems).intersection;
    };
}
...
function resolveNumericScale(factory) {
    if (factory === 'linear') {
        return model.linearScale;
    }
    if (factory === 'log') {
        return model.logScale;
    }
    return factory;
}
function resolveBandScale(factory) {
    return factory === 'band' ? model.bandScale : factory;
}
...
function deriveDataDependent(sets, combinations, sizes, numericScale, bandScale, barLabelFontSize, dotPadding, barPadding, tickFontSize, combinationAddons, toKey, toElemKey, id, setMaxScale, combinationMaxScale) {
    ...
    const cs = areCombinations(combinations)
        ? combinations
        : model.generateCombinations(sets, Object.assign({ toElemKey }, DEFAULT_COMBINATIONS, combinations));
    ...
    return {
        ...
        toKey,
        toElemKey,
        overlapGuesser: model.generateOverlapFunction(cs, noGuessPossible, toKey),
    };
}
...
function ExportButtons({ transform, styleId, exportButtons, exportChart, }) {
    ...
    if (exportButtons === true || exportButtons.svg !== false) {
        acc += svgWidth;
        buttons.push(React__default["default"].createElement("g", { key: "svg", className: `exportButton-${styleId}`, onClick: exportChart, "data-type": "svg", transform: `translate(-${acc}, 0)` },
            React__default["default"].createElement("title", null, "Download SVG Image"),
            React__default["default"].createElement("rect", { y: -9, width: svgWidth, height: 11, rx: 2, ry: 2 }),
            React__default["default"].createElement("text", { className: `exportTextStyle-${styleId}`, x: svgWidth / 2 }, "SVG")));
        acc += space;
    }
    if (exportButtons === true || exportButtons.png !== false) {
        acc += pngWidth;
        buttons.push(React__default["default"].createElement("g", { key: "png", className: `exportButton-${styleId}`, onClick: exportChart, "data-type": "png", transform: `translate(-${acc}, 0)` },
            React__default["default"].createElement("title", null, "Download PNG Image"),
            React__default["default"].createElement("rect", { y: -9, width: pngWidth, height: 11, rx: 2, ry: 2 }),
            React__default["default"].createElement("text", { className: `exportTextStyle-${styleId}`, x: pngWidth / 2 }, "PNG")));
        acc += space;
    }
    if (exportButtons === true || exportButtons.vega !== false) {
        acc += vegaWidth;
        buttons.push(React__default["default"].createElement("g", { key: "vega", className: `exportButton-${styleId}`, onClick: exportChart, "data-type": "vega", transform: `translate(-${acc}, 0)` },
            React__default["default"].createElement("title", null, "Download VEGA-Lite Specification"),
            React__default["default"].createElement("rect", { y: -9, width: vegaWidth, height: 11, rx: 2, ry: 2 }),
            React__default["default"].createElement("text", { className: `exportTextStyle-${styleId}`, x: vegaWidth / 2 }, "VEGA")));
        acc += space;
    }
    if (exportButtons === true || exportButtons.dump !== false) {
        acc += dumpWidth;
        buttons.push(React__default["default"].createElement("g", { key: "dump", className: `exportButton-${styleId}`, onClick: exportChart, "data-type": "dump", transform: `translate(-${acc}, 0)` },
            React__default["default"].createElement("title", null, "Download UpSet.js JSON Dump"),
            React__default["default"].createElement("rect", { y: -9, width: dumpWidth, height: 11, rx: 2, ry: 2 }),
            React__default["default"].createElement("text", { className: `exportTextStyle-${styleId}`, x: dumpWidth / 2 }, "DUMP")));
        acc += space;
    }
    if (exportButtons === true || exportButtons.share !== false) {
        acc += shareWidth;
        buttons.push(React__default["default"].createElement("g", { key: "share", className: `exportButton-${styleId}`, onClick: exportChart, "data-type": "share", transform: `translate(-${acc}, 0)` },
            React__default["default"].createElement("title", null, "Open a shareable URL"),
            React__default["default"].createElement("rect", { y: -9, width: shareWidth, height: 11, rx: 2, ry: 2 }),
            React__default["default"].createElement("text", { className: `exportTextStyle-${styleId}`, x: shareWidth / 2 }, "SHARE")));
        acc += space;
    }
    return (React__default["default"].createElement("g", { className: `exportButtons-${styleId}`, transform: transform }, buttons));
}
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const QueryLegend = /*!#__PURE__*/ React__default["default"].memo(function QueryLegend({ queries, x, style, data, }) {
    return (React__default["default"].createElement("text", { transform: `translate(${x},4)`, style: style.styles.legend, className: clsx(`legendTextStyle-${style.id}`, style.classNames.legend) }, queries.map((q, i) => {
        let count = null;
        if (model.isSetQuery(q)) {
            count = q.set.cardinality;
        }
        else if (model.isElemQuery(q)) {
            count = q.elems instanceof Set ? q.elems.size : q.elems.length;
        }
        return (React__default["default"].createElement(React__default["default"].Fragment, { key: q.name },
            React__default["default"].createElement("tspan", { className: `fillQ${i}-${data.id}` }, '  ⬤ '),
            React__default["default"].createElement("tspan", null,
                q.name,
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const HorizontalTick = /*!#__PURE__*/ React__default["default"].memo(function HorizontalTick({ pos, spacing, tickSizeInner, orient, name, style, }) {
    const k = orient === 'top' || orient === 'left' ? -1 : 1;
    return (React__default["default"].createElement("g", { transform: `translate(0, ${pos + 0.5})` },
        name && (React__default["default"].createElement("text", { x: k * spacing, dy: '0.32em', className: clsx(`axisTextStyle-${style.id}`, orient === 'right' ? `startText-${style.id}` : `endText-${style.id}`, style.classNames.axisTick), style: style.styles.axisTick }, name)),
        React__default["default"].createElement("line", { x2: k * tickSizeInner, className: `axisLine-${style.id}` })));
});
const VerticalTick = /*!#__PURE__*/ React__default["default"].memo(function VerticalTick({ pos, name, spacing, orient, tickSizeInner, style, }) {
    const k = orient === 'top' || orient === 'left' ? -1 : 1;
    return (React__default["default"].createElement("g", { transform: `translate(${pos + 0.5}, 0)` },
        name && (React__default["default"].createElement("text", { y: k * spacing, dy: orient === 'top' ? '0em' : '0.71em', className: clsx(`axisTextStyle-${style.id}`, style.classNames.axisTick), style: style.styles.axisTick }, name)),
        React__default["default"].createElement("line", { y2: k * tickSizeInner, className: `axisLine-${style.id}` })));
});
function Axis({ scale, orient, tickSizeInner = 6, tickSizeOuter = 6, tickPadding = 3, size, start, style, transform, }) {
    ...
    return (React__default["default"].createElement("g", { transform: transform },
        values.map((d) => (React__default["default"].createElement(Tick, { key: d.value, pos: scale(d.value), name: d.label, spacing: spacing, tickSizeInner: tickSizeInner, orient: orient, style: style }))),
        React__default["default"].createElement("path", { className: `axisLine-${style.id}`, d: orient === 'left' || orient === 'right'
                ? tickSizeOuter
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const MultilineText = /*!#__PURE__*/ React__default["default"].memo(function MultilineText({ width, text, dy, x, style, className, }) {
    const ref = React.useRef(null);
    const [lines, setLines] = React.useState(typeof text === 'string' ? [text] : []);
    ...
    return (React__default["default"].createElement("tspan", { ref: ref, dy: dy, style: style, x: x, className: className }, lines.length > 1
        ? lines.map((l, i) => (React__default["default"].createElement("tspan", { key: l, x: 0, dy: i > 0 ? '1.2em' : dy }, l)))
        : text));
});
var UpSetTitle = /*!#__PURE__*/ React__default["default"].memo(function UpSetTitle({ width, descriptionWidth = width, style, }) {
    if (!style.title && !style.description) {
        return null;
    }
    return (React__default["default"].createElement("text", null,
        React__default["default"].createElement(MultilineText, { text: style.title, width: width, dy: "10px", className: clsx(`titleTextStyle-${style.id}`, style.classNames.title), style: style.styles.title }),
        React__default["default"].createElement(MultilineText, { x: 0, width: descriptionWidth, dy: style.title ? '2em' : '10px', text: style.description, className: clsx(`descTextStyle-${style.id}`, style.classNames.description), style: style.styles.description })));
});
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const UpSetAxis = /*!#__PURE__*/ React__default["default"].memo(function UpSetAxis({ size, style, data }) {
    ...
    return (React__default["default"].createElement("g", null,
        React__default["default"].createElement(UpSetTitle, { style: style, width: size.cs.x - csNameOffset - 20 }),
        size.cs.h > 0 && (React__default["default"].createElement("g", { transform: `translate(${size.cs.x},${size.cs.y})`, "data-upset": "csaxis" },
            React__default["default"].createElement(Axis, { scale: data.cs.y, orient: "left", size: size.cs.h, start: size.cs.h - data.cs.yAxisWidth, style: style }),
            React__default["default"].createElement("line", { x1: 0, x2: size.cs.w, y1: size.cs.h + 1, y2: size.cs.h + 1, className: `axisLine-${style.id}` }),
            React__default["default"].createElement("text", { className: clsx(`cChartTextStyle-${style.id}`, style.classNames.chartLabel), style: style.styles.chartLabel, transform: `translate(${-csNameOffset}, ${size.cs.h / 2})rotate(-90)` }, style.cs.name),
            size.cs.addons.map((addon) => {
                const pos = combinationPosGen(addon);
                const title = (React__default["default"].createElement("text", { key: addon.name, className: clsx(`cChartTextStyle-${style.id}`, style.classNames.chartLabel), style: style.styles.chartLabel, transform: `translate(${-csNameOffset}, ${pos + addon.size / 2})rotate(-90)` }, addon.name));
                if (!addon.scale) {
                    return title;
                }
                return (React__default["default"].createElement(React__default["default"].Fragment, { key: addon.name },
                    React__default["default"].createElement(Axis, { scale: addon.scale, orient: "left", size: addon.size, start: 0, style: style, transform: `translate(0,${pos})` }),
                    title));
            }))),
        size.sets.w > 0 && (React__default["default"].createElement("g", { transform: `translate(${size.sets.x},${size.sets.y})`, "data-upset": "setaxis" },
            React__default["default"].createElement(Axis, { scale: data.sets.x, orient: "bottom", size: size.sets.w, start: size.sets.w - data.sets.xAxisWidth, transform: `translate(0, ${size.sets.h})`, style: style }),
            React__default["default"].createElement("text", { className: clsx(`sChartTextStyle-${style.id}`, style.classNames.chartLabel), style: style.styles.chartLabel, transform: `translate(${size.sets.w / 2}, ${size.sets.h + setNameOffset})` }, style.sets.name),
            size.sets.addons.map((addon) => {
                const pos = setPosGen(addon);
                const title = (React__default["default"].createElement("text", { key: addon.name, className: clsx(`sChartTextStyle-${style.id}`, style.classNames.chartLabel), style: style.styles.chartLabel, transform: `translate(${pos + addon.size / 2}, ${size.sets.h + setNameOffset})` }, addon.name));
                if (!addon.scale) {
                    return title;
                }
                return (React__default["default"].createElement(React__default["default"].Fragment, { key: addon.name },
                    React__default["default"].createElement(Axis, { scale: addon.scale, orient: "bottom", size: addon.size, start: 0, transform: `translate(${pos}, ${size.sets.h})`, style: style }),
                    title));
            })))));
});
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const UpSetDot = /*!#__PURE__*/ React__default["default"].memo(function UpSetDot({ cx, r, cy, name, className, style, fill, }) {
    return (React__default["default"].createElement("circle", { r: r, cx: cx, cy: cy, className: className, style: mergeColor(style, fill) }, name && React__default["default"].createElement("title", null, name)));
});
...
const CombinationChart = /*!#__PURE__*/ React__default["default"].memo(function CombinationChart({ d, h, className, data, size, style, children, }) {
    ...
    return (React__default["default"].createElement("g", { transform: `translate(${data.cs.x(d)}, 0)`, onMouseEnter: h.onMouseEnter(d, size.cs.addons), onMouseLeave: h.onMouseLeave, onClick: h.onClick(d, size.cs.addons), onContextMenu: h.onContextMenu(d, size.cs.addons), onMouseMove: h.onMouseMove(d, size.cs.addons), className: className, "data-cardinality": d.cardinality },
        style.tooltips && (React__default["default"].createElement("title", null,
            d.name,
            ": ",
            data.cs.format(d.cardinality))),
        React__default["default"].createElement("rect", { y: -size.cs.before, width: data.cs.bandWidth, height: size.sets.h + size.cs.h + size.cs.before + size.cs.after, className: `hoverBar-${style.id}` }),
        size.cs.h > 0 && (React__default["default"].createElement(React__default["default"].Fragment, null,
            yValues.map((y, i) => {
                const offset = i > 0 ? Math.floor(data.cs.bandWidth * OVERFLOW_PADDING_FACTOR[i - 1]) : 0;
                return (React__default["default"].createElement("rect", { key: i, x: offset, y: y, height: size.cs.h - y, width: data.cs.bandWidth - offset * 2, className: clsx(`fillPrimary-${style.id}`, i < yValues.length - 1 && `fillOverflow${yValues.length - 1 - i}-${style.id}`, style.classNames.bar), style: mergeColor(style.styles.bar, d.color) }));
            }),
            React__default["default"].createElement("text", { y: yValues[0] - style.barLabelOffset, x: data.cs.bandWidth / 2, style: style.styles.barLabel, className: clsx(`cBarTextStyle-${style.id}`, style.classNames.barLabel) }, data.cs.format(d.cardinality)))),
        React__default["default"].createElement("text", { y: -style.barLabelOffset - size.cs.before, x: data.cs.bandWidth / 2, style: style.styles.barLabel, className: clsx(`hoverBarTextStyle-${style.id}`, style.classNames.barLabel) }, d.name),
        data.sets.v.map((s, i) => {
            if (data.cs.has(d, s)) {
                // only not
                return null;
            }
            return (React__default["default"].createElement(UpSetDot, { key: data.sets.keys[i], r: data.r, cx: data.cs.cx, cy: data.sets.y(s) + data.sets.cy, name: style.tooltips ? d.name : '', style: style.styles.dot, fill: undefined, className: clsx(`fillNotMember-${style.id}`, style.classNames.dot) }));
        }),
        d.sets.size > 1 && (React__default["default"].createElement("line", { x1: data.cs.cx, y1: data.sets.y(data.sets.v.find((p) => data.cs.has(d, p))) + data.sets.cy - (data.r - 1), x2: data.cs.cx, y2: data.sets.y(data.sets.rv.find((p) => data.cs.has(d, p))) + data.sets.cy + (data.r - 1), style: d.color ? { stroke: d.color } : undefined, className: `upsetLine-${data.id}` })),
        data.sets.v.map((s, i) => {
            var _a;
            if (!data.cs.has(d, s)) {
                // only has
            ...
            return (React__default["default"].createElement(UpSetDot, { key: data.sets.keys[i], r: data.r, cx: data.cs.cx, cy: data.sets.y(s) + data.sets.cy, name: style.tooltips ? s.name : '', style: style.styles.dot, fill: (_a = s.color) !== null && _a !== void 0 ? _a : d.color, className: clsx(`fillPrimary-${style.id}`, style.classNames.dot) }));
        }),
        size.cs.addons.map((addon) => (React__default["default"].createElement("g", { key: addon.name, transform: `translate(0,${genPosition(addon)})` }, addon.render({ set: d, width: data.cs.bandWidth, height: addon.size, theme: style.theme })))),
        children));
});
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const SetChart = /*!#__PURE__*/ React__default["default"].memo(function SetChart({ d, i, h, className, size, data, style, children, }) {
    ...
    const anchorOffset = style.setLabelAlignment === 'center'
        ...
        : style.setLabelAlignment === 'left'
            ? 2
            : size.labels.w - 2;
    return (React__default["default"].createElement("g", { transform: `translate(0, ${data.sets.y(d)})`, onMouseEnter: h.onMouseEnter(d, size.sets.addons), onMouseLeave: h.onMouseLeave, onClick: h.onClick(d, size.sets.addons), onContextMenu: h.onContextMenu(d, size.sets.addons), onMouseMove: h.onMouseMove(d, size.sets.addons), className: className, "data-cardinality": d.cardinality },
        style.tooltips && (React__default["default"].createElement("title", null,
            d.name,
            ": ",
            data.sets.format(d.cardinality))),
        React__default["default"].createElement("rect", { x: -size.sets.before, width: size.sets.w + size.labels.w + size.cs.w + size.sets.after, height: data.sets.bandWidth, className: `hoverBar-${style.id}` }),
        i % 2 === 1 && (React__default["default"].createElement("rect", { x: size.sets.w, width: size.labels.w + size.cs.w + size.sets.after, height: data.sets.bandWidth, className: `fillAlternating-${style.id}` })),
        size.sets.w > 0 && (React__default["default"].createElement(React__default["default"].Fragment, null,
            xValues.map((x, i) => {
                const offset = i > 0 ? Math.floor(data.sets.bandWidth * OVERFLOW_PADDING_FACTOR[i - 1]) : 0;
                return (React__default["default"].createElement("rect", { key: i, x: x, y: offset, width: size.sets.w - x, height: data.sets.bandWidth - offset * 2, className: clsx(`fillPrimary-${style.id}`, i < xValues.length - 1 && `fillOverflow${xValues.length - 1 - i}-${style.id}`, style.classNames.bar), style: mergeColor(style.styles.bar, d.color) }));
            }),
            React__default["default"].createElement("text", { x: xValues[0], dx: -style.barLabelOffset, y: data.sets.bandWidth / 2, style: style.styles.barLabel, className: clsx(`sBarTextStyle-${style.id}`, style.classNames.barLabel) }, data.sets.format(d.cardinality)))),
        React__default["default"].createElement("text", { x: size.sets.w + anchorOffset, y: data.sets.bandWidth / 2, className: clsx(`setTextStyle-${style.id}`, style.classNames.setLabel), style: style.styles.setLabel, clipPath: `url(#clip-${size.id})` }, d.name),
        size.sets.addons.map((addon) => (React__default["default"].createElement("g", { key: addon.name, transform: `translate(${genPosition(addon)},0)` }, addon.render({ set: d, width: addon.size, height: data.sets.bandWidth, theme: style.theme })))),
        children));
});
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const UpSetChart = /*!#__PURE__*/ React__default["default"].memo(function UpSetChart({ data, size, style, h, setChildrenFactory, combinationChildrenFactory, }) {
    return (React__default["default"].createElement("g", { className: h.hasClick ? `clickAble-${style.id}` : undefined },
        React__default["default"].createElement("g", { transform: `translate(${size.sets.x},${size.sets.y})`, "data-upset": "sets" }, data.sets.v.map((d, i) => (React__default["default"].createElement(SetChart, { key: data.sets.keys[i], d: d, i: i, h: h, className: h.hasClick || h.hasHover ? `interactive-${style.id}` : undefined, data: data, style: style, size: size }, setChildrenFactory && setChildrenFactory(d))))),
        React__default["default"].createElement("g", { transform: `translate(${size.cs.x},${size.cs.y})`, "data-upset": "cs" }, data.cs.v.map((d, i) => (React__default["default"].createElement(CombinationChart, { key: data.cs.keys[i], d: d, h: h, className: h.hasClick || h.hasHover ? `interactive-${style.id}` : undefined, data: data, style: style, size: size }, combinationChildrenFactory && combinationChildrenFactory(d)))))));
});
...
function CombinationSelectionChart({ data, size, style, elemOverlap, secondary, tooltip, suffix, transform, empty, combinationAddons, }) {
    ...
    return (React__default["default"].createElement("g", { transform: transform, "data-upset": secondary ? 'cs-q' : 'cs-s' }, data.cs.v.map((d, i) => {
        const x = data.cs.x(d);
        const key = data.cs.keys[i];
        if (empty && !secondary) {
            return (React__default["default"].createElement("rect", { key: key, x: x, y: height, height: 0, width: width, className: className, style: mergeColor(style.styles.bar, !style.selectionColor ? d.color : undefined) }, tooltip && React__default["default"].createElement("title", null)));
        }
        ...
        const title = tooltip && React__default["default"].createElement("title", null, `${d.name} ∩ ${tooltip}: ${o}`);
        const content = secondary ? (React__default["default"].createElement("path", { key: key, transform: `translate(${x}, ${yValues[0]})`, d: `M0,-1 l${width},0 l0,2 l${-width},0 L-${data.triangleSize},-${data.triangleSize} L-${data.triangleSize},${data.triangleSize} Z`, className: className, "data-i": i, "data-cardinality": o, style: mergeColor(undefined, !style.selectionColor ? d.color : undefined) }, title)) : (yValues.map((y, j) => {
            const offset = j > 0 ? Math.floor(data.cs.bandWidth * OVERFLOW_PADDING_FACTOR[j - 1]) : 0;
            return (React__default["default"].createElement("rect", { key: j, x: x + offset, y: y, height: height - y, width: width - offset * 2, "data-i": j > 0 ? null : i, "data-cardinality": j > 0 ? null : o, className: clsx(className, j < yValues.length - 1 && `fillOverflow${yValues.length - 1 - j}-${style.id}`), style: mergeColor(style.styles.bar, !style.selectionColor ? d.color : undefined) }, title));
        }));
        ...
        const addons = combinationAddons
            ...
            return (React__default["default"].createElement("g", { key: addon.name, transform: `translate(${x},${v})` }, content));
        })
            .filter(Boolean);
        if (addons.length === 0) {
            return content;
        }
        return (React__default["default"].createElement("g", { key: key },
            content,
            addons));
    })));
}
...
function SetSelectionChart({ data, size, style, elemOverlap, suffix, secondary, empty, tooltip, setAddons, transform, }) {
    ...
    const className = clsx(`fill${suffix}`, !tooltip && ` pnone-${style.id}`, style.classNames.bar);
    return (React__default["default"].createElement("g", { transform: transform, "data-upset": secondary ? 'sets-q' : 'sets-s' }, data.sets.v.map((d, i) => {
        const y = data.sets.y(d);
        const key = data.sets.keys[i];
        if (empty && !secondary) {
            return (React__default["default"].createElement("rect", { key: key, x: width, y: y, width: 0, height: height, className: className, style: mergeColor(style.styles.bar, !style.selectionColor ? d.color : undefined) }, style.tooltips && tooltip && React__default["default"].createElement("title", null)));
        }
        const o = elemOverlap(d);
        if (o === 0) {
            return null;
        ...
        const title = style.tooltips && tooltip && React__default["default"].createElement("title", null, `${d.name} ∩ ${tooltip}: ${o}`);
        const content = secondary ? (React__default["default"].createElement("path", { key: key, transform: `translate(${xValues[0]}, ${y + height})`, d: `M1,0 l0,${-height} l-2,0 l0,${height} L-${data.triangleSize},${data.triangleSize} L${data.triangleSize},${data.triangleSize} Z`, "data-i": i, "data-cardinality": o, className: className, style: mergeColor(undefined, !style.selectionColor ? d.color : undefined) }, title)) : (xValues.map((x, j) => {
            const offset = j > 0 ? Math.floor(data.sets.bandWidth * OVERFLOW_PADDING_FACTOR[j - 1]) : 0;
            return (React__default["default"].createElement("rect", { key: j, "data-i": j > 0 ? null : i, "data-cardinality": j > 0 ? null : o, x: x, y: y + offset, width: width - x, height: height - offset * 2, className: clsx(className, j < xValues.length - 1 && `fillOverflow${xValues.length - 1 - j}-${style.id}`), style: mergeColor(style.styles.bar, !style.selectionColor ? d.color : undefined) }, title));
        }));
        ...
        const addons = setAddons
            ...
            return (React__default["default"].createElement("g", { key: addon.name, transform: `translate(${v},${y})` }, content));
        })
            .filter(Boolean);
        if (addons.length === 0) {
            return content;
 ...
 */
const EMPTY_ARRAY$1 = [];
const UpSetQueries = /*!#__PURE__*/ React__default["default"].memo(function UpSetQueries({ size, data, style, hasHover, secondary, queries, }) {
    const someAddon = size.sets.addons.some((s) => s.renderQuery != null) || size.cs.addons.some((s) => s.renderQuery != null);
    const qs = React.useMemo(() => queries.map((q) => (Object.assign(Object.assign({}, q), { overlap: model.queryOverlap(q, 'intersection', data.toElemKey), elemOverlap: someAddon ? model.queryElemOverlap(q, 'intersection', data.toElemKey) : null }))), [queries, someAddon, data.toElemKey]);
    ...
    return (React__default["default"].createElement("g", { className: hasHover && !secondary ? `pnone-${style.id}` : undefined },
        React__default["default"].createElement("g", { transform: `translate(${size.sets.x},${size.sets.y})` }, qs.map((q, i) => (React__default["default"].createElement(SetSelectionChart, { key: q.name, data: data, size: size, style: style, elemOverlap: q.overlap, suffix: `Q${i}-${data.id}`, secondary: secondary || i > 0, tooltip: hasHover && !(secondary || i > 0) ? undefined : q.name, setAddons: size.sets.addons.length === 0
                ? EMPTY_ARRAY$1
                : size.sets.addons.map((a, i) => wrapAddon(a, q, i, q.elemOverlap, secondary || i > 0)) })))),
        React__default["default"].createElement("g", { transform: `translate(${size.cs.x},${size.cs.y})` }, qs.map((q, i) => (React__default["default"].createElement(CombinationSelectionChart, { key: q.name, data: data, size: size, style: style, elemOverlap: q.overlap, suffix: `Q${i}-${data.id}`, secondary: secondary || i > 0, tooltip: hasHover && !(secondary || i > 0) ? undefined : q.name, combinationAddons: size.cs.addons.length === 0
                ? EMPTY_ARRAY$1
...
function LabelsSelection({ data, size, style, selection, }) {
    ...
    const d = selection;
    return (React__default["default"].createElement("rect", { y: data.sets.y(d), width: size.labels.w + size.cs.w + size.sets.after, height: data.sets.bandWidth, className: `selectionHint-${style.id}` }));
}
...
function UpSetSelectionChart({ data, size, style, selection, }) {
    ...
    return (React__default["default"].createElement("g", { transform: `translate(${size.labels.w + data.cs.x(d)}, 0)`, "data-upset": "cs-ss", "data-i": index },
        React__default["default"].createElement("rect", { width: width, height: height, className: `selectionHint-${style.id}` }),
        d.sets.size > 1 && (React__default["default"].createElement("line", { x1: cx, y1: data.sets.y(data.sets.v.find((p) => data.cs.has(d, p))) + cy - (data.r - 1), x2: cx, y2: data.sets.y(data.sets.rv.find((p) => data.cs.has(d, p))) + cy + (data.r - 1), className: `upsetSelectionLine-${data.id}`, style: mergeColor(undefined, !style.selectionColor ? d.color : undefined, 'stroke') })),
        data.sets.v
            .filter((s) => data.cs.has(d, s))
            .map((s) => (React__default["default"].createElement(UpSetDot, { key: data.toKey(s), r: r * 1.1, cx: cx, cy: data.sets.y(s) + cy, name: style.tooltips ? s.name : '', className: clsx(`fillSelection-${style.id}`, `pnone-${style.id}`, style.classNames.dot), style: mergeColor(style.styles.dot, !style.selectionColor ? s.color : undefined) })))));
}
...
function UpSetSelection({ size, data, style, selection, hasHover, }) {
    ...
    return (React__default["default"].createElement("g", { className: hasHover ? `pnone-${style.id}` : undefined },
        (selection || empty) && (React__default["default"].createElement(CombinationSelectionChart, { data: data, size: size, style: style, transform: `translate(${size.cs.x},${size.cs.y})`, empty: empty && !selection, elemOverlap: selectionOverlap, suffix: `Selection-${style.id}`, tooltip: hasHover ? undefined : selectionName, combinationAddons: size.cs.addons.length === 0 ? EMPTY_ARRAY : size.cs.addons.map(wrapAddon) })),
        (selection || empty) && (React__default["default"].createElement(SetSelectionChart, { data: data, size: size, style: style, transform: `translate(${size.sets.x},${size.sets.y})`, empty: empty && !selection, elemOverlap: selectionOverlap, suffix: `Selection-${style.id}`, tooltip: hasHover ? undefined : selectionName, setAddons: size.sets.addons.length === 0 ? EMPTY_ARRAY : size.sets.addons.map(wrapAddon) })),
        React__default["default"].createElement("g", { transform: `translate(${size.labels.x},${size.labels.y})` },
            isSetLike(selection) && React__default["default"].createElement(LabelsSelection, { data: data, size: size, style: style, selection: selection }),
            isSetLike(selection) && React__default["default"].createElement(UpSetSelectionChart, { data: data, size: size, style: style, selection: selection }))));
}
 ...
 */
const UpSetJS = /*!#__PURE__*/ React__default["default"].forwardRef(function UpSetJS(props, ref) {
    var _a;
    ...
    const styleId = React.useMemo(() => p.id
        ? p.id
        : generateId([
            p.fontFamily,
            fontSizes.axisTick,
    ...
    const styleInfo = React.useMemo(() => deriveStyleDependent$1(p.theme, p.styles, p.classNames, p.combinationName, p.combinationNameAxisOffset, p.setName, p.setNameAxisOffset, styleId, p.barLabelOffset, p.selectionColor, p.emptySelection, p.title, p.description, p.tooltips, p.setLabelAlignment), [
        p.theme,
        p.styles,
        p.classNames,
        p.barLabelOffset,
    ...
    const sizeInfo = React.useMemo(() => deriveSizeDependent(p.width, p.height, p.padding, p.barPadding, p.widthRatios, p.heightRatios, p.setAddons, p.combinationAddons, p.id, p.setAddonPadding, p.combinationAddonPadding), [
        p.width,
        p.height,
        p.padding,
        p.barPadding,
    ...
    const dataInfo = React.useMemo(() => deriveDataDependent(p.sets, p.combinations, sizeInfo, p.numericScale, p.bandScale, p.barLabelOffset + parseFontSize(fontSizes.barLabel), p.dotPadding, p.barPadding, parseFontSize(fontSizes.axisTick), p.combinationAddons, p.toKey, p.toElemKey, p.id, p.setMaxScale, p.combinationMaxScale), [
        p.sets,
        p.combinations,
        sizeInfo,
        p.numericScale,
  ...
  ${queries
    ...
    fill: ${q.color};
        ...
        .join('\n')}
  `;
    const exportChart = React.useCallback((evt) => {
    ...
    const selectionName = generateSelectionName(selection);
    return (React__default["default"].createElement("svg", { id: p.id, className: clsx(`root-${styleId}`, p.className), style: p.style, width: p.width, height: p.height, ref: ref, viewBox: `0 0 ${p.width} ${p.height}`, "data-theme": (_a = p.theme) !== null && _a !== void 0 ? _a : 'light', "data-selection": selectionName ? selectionName : undefined },
        p.styleFactory(rules),
        React__default["default"].createElement("defs", null,
            React__default["default"].createElement("clipPath", { id: `clip-${sizeInfo.id}` },
                React__default["default"].createElement("rect", { x: sizeInfo.sets.w, y: 0, width: sizeInfo.labels.w, height: sizeInfo.sets.h }))),
        p.queryLegend && React__default["default"].createElement(QueryLegend, { queries: queries, x: sizeInfo.legend.x, style: styleInfo, data: dataInfo }),
        React__default["default"].createElement(ExportButtons, { transform: `translate(${sizeInfo.w - 2},${sizeInfo.h - 3})`, styleId: styleId, exportButtons: p.exportButtons, exportChart: exportChart }),
        React__default["default"].createElement("g", { transform: `translate(${p.padding},${p.padding})`, "data-upset": "base" },
            p.onClick && (React__default["default"].createElement("rect", { width: sizeInfo.cs.x, height: sizeInfo.sets.y, onClick: h.reset, className: `fillTransparent-${styleId}` })),
            React__default["default"].createElement(UpSetAxis, { size: sizeInfo, style: styleInfo, data: dataInfo }),
            React__default["default"].createElement(UpSetChart, { size: sizeInfo, style: styleInfo, data: dataInfo, h: h, setChildrenFactory: p.setChildrenFactory, combinationChildrenFactory: p.combinationChildrenFactory }),
            React__default["default"].createElement(UpSetSelection, { size: sizeInfo, style: styleInfo, data: dataInfo, hasHover: h.hasHover, selection: selection }),
            React__default["default"].createElement(UpSetQueries, { size: sizeInfo, style: styleInfo, data: dataInfo, hasHover: h.hasHover, queries: queries, secondary: p.onHover != null || selection != null })),
        props.children));
});

function SVGWrapper({ rules, style, size, p, data, tRef, children, exportChart, selectionName, h, }) {
    var _a, _b;
    return (React__default["default"].createElement("svg", { id: p.id, className: clsx(`root-${style.id}`, p.className), style: p.style, width: p.width, height: p.height, ref: tRef, viewBox: `0 0 ${p.width} ${p.height}`, "data-theme": (_a = p.theme) !== null && _a !== void 0 ? _a : 'light', "data-selection": selectionName ? selectionName : undefined },
        p.styleFactory(rules),
        p.onClick && React__default["default"].createElement("rect", { width: size.w, height: size.h, onClick: h.reset, className: `fillTransparent-${style.id}` }),
        p.queryLegend && React__default["default"].createElement(QueryLegend, { queries: (_b = p.queries) !== null && _b !== void 0 ? _b : [], x: size.legend.x, style: style, data: data }),
        React__default["default"].createElement(ExportButtons, { transform: `translate(${size.w - 2},${size.h - 3})`, styleId: style.id, exportButtons: p.exportButtons, exportChart: exportChart }),
        React__default["default"].createElement("g", { transform: `translate(${p.padding},${p.padding})`, "data-upset": "base" }, children),
        p.children));
}
...
function SelectionPattern(p) {
    ...
    return (React__default["default"].createElement("defs", null,
        React__default["default"].createElement("pattern", { id: p.id, width: "1", height: "0.1", patternContentUnits: "objectBoundingBox", patternTransform: `rotate(${(_a = p.rotate) !== null && _a !== void 0 ? _a : 0})` },
            p.bgFilled && (React__default["default"].createElement("rect", { x: "0", y: "0", width: "1", height: "0.1", style: { fill: p.bgFill }, className: `fillPrimary-${p.styleId}` })),
            React__default["default"].createElement("rect", { x: "0", y: "0", width: "1", height: ratio, className: `fill${p.suffix}`, style: p.fill ? { fill: p.fill } : undefined }))));
}
...
function generateTitle(d, s, sName, secondary, qs, queries, data, cx) {
    ...
    if (qs.length === 0) {
        return {
            ...
            title: d.type === 'set' ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                React__default["default"].createElement("tspan", { dy: "-0.6em" }, d.name),
                React__default["default"].createElement("tspan", { x: cx, dy: "1.2em" }, baseCardinality))) : (baseCardinality),
        };
    }
    if (qs.length === 1 && !secondary && !sName) {
        return {
            ...
            title: d.type === 'set' ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                React__default["default"].createElement("tspan", { dy: "-0.6em" }, d.name),
                React__default["default"].createElement("tspan", { x: cx, dy: "1.2em" }, `${data.format(qs[0])}/${dc}`))) : (`${data.format(qs[0])}/${dc}`),
        };
    }
    const queryLine = (React__default["default"].createElement("tspan", { x: cx, dy: "1.2em" }, queries.map((q, i) => (React__default["default"].createElement(React__default["default"].Fragment, { key: q.name },
        React__default["default"].createElement("tspan", { className: `fillQ${i}-${data.id}` }, '⬤'),
        React__default["default"].createElement("tspan", null, ` ${data.format(qs[i])}/${dc}${i < queries.length - 1 ? ' ' : ''}`))))));
    return {
        tooltip: `${baseName}: ${baseCardinality}\n${queries
            .map((q, i) => `${d.name} ∩ ${q.name}: ${data.format(qs[i])}/${dc}`)
            .join('\n')}`,
        title: d.type === 'set' ? (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement("tspan", { dy: "-1.2em" }, d.name),
            React__default["default"].createElement("tspan", { x: cx, dy: "1.2em" }, baseCardinality),
            queryLine)) : (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement("tspan", { dy: "-0.6em" }, baseCardinality),
            queryLine)),
    };
}
function VennArcSliceSelection({ slice, d, i, data, style, elemOverlap, selected, selectionName, h, queries, size, fill, qs, }) {
    ...
    return (React__default["default"].createElement("g", null,
        React__default["default"].createElement(SelectionPattern, { id: id, v: o === 0 ? 0 : o / d.cardinality, suffix: `Selection-${style.id}`, rotate: rotate, bgFill: d.color, bgFilled: d.color != null || fill, fill: !style.selectionColor ? d.color : undefined, styleId: style.id }),
        React__default["default"].createElement("path", { onMouseEnter: h.onMouseEnter(d, []), onMouseLeave: h.onMouseLeave, onClick: h.onClick(d, []), onContextMenu: h.onContextMenu(d, []), onMouseMove: h.onMouseMove(d, []), d: p, className: className, style: mergeColor(style.styles.set, o > 0 && o < d.cardinality ? `url(#${id})` : !fillFullSelection || !style.selectionColor ? d.color : undefined) }, style.tooltips && React__default["default"].createElement("title", null, tooltip)),
        React__default["default"].createElement("text", { x: slice.text.x, y: slice.text.y, className: clsx(`${d.type === 'set' ? 'set' : 'value'}TextStyle-${style.id}`, `pnone-${style.id}`, d.type === 'set' ? style.classNames.setLabel : style.classNames.valueLabel
...
function deriveVennDataDependent(sets, combinations, size, layout, format, toKey, toElemKey, id, setLabelOffsets) {
    ...
    return {
        ...
        toKey,
        toElemKey,
        overlapGuesser: model.generateDistinctOverlapFunction(cs, noGuessPossible, toKey),
    };
}
function calculateCombinations(ss, toKey, combinations, options = { min: 1 }) {
    ...
    if (areCombinations(combinations)) {
        ...
        cs = model.generateCombinations(helperSets, Object.assign({
        ...
        cs = model.generateCombinations(ss, Object.assign({
            type: 'distinctIntersection',
            empty: true,
            order: ['degree:asc', 'group:asc'],
...
function useCreateCommon(p) {
    ...
    const styleInfo = React.useMemo(() => deriveVennStyleDependent(p.theme, p.styles, p.classNames, styleId, p.selectionColor, p.title, p.description, p.tooltips), [p.theme, p.styles, p.classNames, styleId, p.selectionColor, p.title, p.description, p.tooltips]);
    const sizeInfo = React.useMemo(() => deriveVennSizeDependent(p.width, p.height, p.padding, p.id), [p.width, p.height, p.padding, p.id]);
    const h = useHandler(p);
    const qs = React__default["default"].useMemo(() => queries.map((q) => model.queryOverlap(q, 'intersection', p.toElemKey)), [queries, p.toElemKey]);
    const rulesHelper = baseRules(styleId, p, p.fontFamily, fontSizes);
    return {
        styleId,
        size: sizeInfo,
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const VennDiagram = /*!#__PURE__*/ React__default["default"].forwardRef(function VennDiagram(props, ref) {
    const p = fillVennDiagramDefaults(props);
    const { selection = null, queries = [], fontSizes } = p;
    const v = useCreateCommon(p);
    const { size, style, rulesHelper } = v;
    const dataInfo = React.useMemo(() => deriveVennDataDependent(p.sets, p.combinations, size, p.layout, p.valueFormat, p.toKey, p.toElemKey, p.id, p.setLabelOffsets), [p.sets, p.combinations, size, p.valueFormat, p.toKey, p.toElemKey, p.id, p.layout, p.setLabelOffsets]);
    const selectionKey = selection != null && model.isSetLike(selection) ? p.toKey(selection) : null;
  ...
  `;
    ...
    return (React__default["default"].createElement(SVGWrapper, { rules: rules, style: style, selectionName: selectionName, size: size, p: p, data: dataInfo, tRef: ref, h: v.h, exportChart: exportChart },
        React__default["default"].createElement(UpSetTitle, { style: style, width: maxWidth }),
        React__default["default"].createElement("g", { className: clsx(p.onClick && `clickAble-${style.id}`) }, dataInfo.sets.d.map((d, i) => (React__default["default"].createElement("text", { key: d.key, x: d.l.text.x + d.offset.x, y: d.l.text.y + d.offset.y, onClick: v.h.onClick(dataInfo.sets.v[i], []), onMouseEnter: v.h.onMouseEnter(dataInfo.sets.v[i], []), onMouseLeave: v.h.onMouseLeave, onContextMenu: v.h.onContextMenu(dataInfo.sets.v[i], []), onMouseMove: v.h.onMouseMove(dataInfo.sets.v[i], []), className: clsx(`setTextStyle-${style.id}`, `${d.l.align}Text-${style.id}`, `${d.l.verticalAlign}Text-${style.id}`, style.classNames.setLabel) },
            style.tooltips && (React__default["default"].createElement("title", null,
                dataInfo.sets.v[i].name,
                ": ",
                dataInfo.format(dataInfo.sets.v[i].cardinality))),
            dataInfo.sets.v[i].name)))),
        React__default["default"].createElement("g", { className: clsx(p.onClick && `clickAble-${style.id}`) }, dataInfo.cs.d.map((l, i) => (React__default["default"].createElement(VennArcSliceSelection, { key: l.key, d: l.v, i: i, slice: l.l, size: size, style: style, data: dataInfo, fill: p.filled, h: v.h, selectionName: selectionName, selected: selectionKey === l.key || (model.isSet(selection) && dataInfo.cs.has(l.v, selection)), elemOverlap: selectionOverlap, queries: queries, qs: v.qs })))),
        React__default["default"].createElement("g", null, dataInfo.sets.d.map((l) => isEllipse(l.l) ? (React__default["default"].createElement("ellipse", { key: l.key, rx: l.l.rx, ry: l.l.ry, transform: `translate(${l.l.cx},${l.l.cy})rotate(${l.l.rotation})`, className: clsx(`stroke-circle-${style.id}`, style.classNames.set), style: style.styles.set })) : (React__default["default"].createElement("circle", { key: l.key, cx: l.l.cx, cy: l.l.cy, r: l.l.r, className: clsx(`stroke-circle-${style.id}`, style.classNames.set), style: style.styles.set }))))));
});
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const KMapCell = /*!#__PURE__*/ React__default["default"].memo(function KMapCell({ d, i, h, className, data, style }) {
    const l = data.cs.l[i];
    const y = data.cs.scale(d.cardinality);
    const x = (data.cell - data.cs.bandWidth) / 2;
    return (React__default["default"].createElement("g", { transform: `translate(${l.x}, ${l.y})`, onMouseEnter: h.onMouseEnter(d, []), onMouseLeave: h.onMouseLeave, onClick: h.onClick(d, []), onContextMenu: h.onContextMenu(d, []), onMouseMove: h.onMouseMove(d, []), className: className, "data-cardinality": d.cardinality },
        style.tooltips && (React__default["default"].createElement("title", null,
            d.name,
            ": ",
            data.sets.format(d.cardinality))),
        React__default["default"].createElement("rect", { width: data.cell, height: data.cell, className: `fillTransparent-${style.id}` }),
        React__default["default"].createElement("rect", { x: x, y: y, height: data.cell - y, width: data.cs.bandWidth, className: clsx(`fillPrimary-${style.id}`, style.classNames.bar), style: mergeColor(style.styles.bar, d.color) }),
        React__default["default"].createElement("text", { y: y - style.barLabelOffset, x: data.cell / 2, style: style.styles.barLabel, className: clsx(`barTextStyle-${style.id}`, style.classNames.barLabel) }, data.sets.format(d.cardinality))));
});
...
const KMapChart = /*!#__PURE__*/ React__default["default"].memo(function KMapChart({ data, style, size, h }) {
    const csNameOffset = style.cs.offset === 'auto' ? data.cs.labelOffset : style.cs.offset;
    return (React__default["default"].createElement("g", null,
        React__default["default"].createElement("g", { transform: `translate(${size.w - csNameOffset - 2}, ${size.h - data.cell - 50})` },
            React__default["default"].createElement(Axis, { scale: data.cs.scale, orient: "left", size: data.cell, start: data.cs.barLabelFontSize, style: style }),
            React__default["default"].createElement("text", { className: clsx(`cChartTextStyle-${style.id}`, style.classNames.chartLabel), style: style.styles.chartLabel, transform: `translate(${-csNameOffset}, ${data.cell})rotate(-90)` }, style.cs.name)),
        React__default["default"].createElement("g", null,
            data.sets.l.map((l, i) => {
                const s = data.sets.v[i];
                const name = s.name;
                return (React__default["default"].createElement("g", { key: name, onClick: h.onClick(s, []), onMouseEnter: h.onMouseEnter(s, []), onMouseLeave: h.onMouseLeave, onContextMenu: h.onContextMenu(s, []), onMouseMove: h.onMouseMove(s, []), className: clsx(h.hasClick && `clickAble-${style.id}`) }, l.text.map((p, i) => (React__default["default"].createElement("text", { key: i, transform: `translate(${p.x},${p.y})${!l.hor ? 'rotate(-90)' : ''}`, className: clsx(`setTextStyle-${style.id}`) }, name)))));
            }),
            data.sets.l.map((l, i) => {
                const name = data.sets.v[i].name;
                return (React__default["default"].createElement(React__default["default"].Fragment, { key: name }, l.notText.map((p, i) => (React__default["default"].createElement("text", { key: i, transform: `translate(${p.x},${p.y})${!l.hor ? 'rotate(-90)' : ''}`, className: clsx(`setTextStyle-${style.id}`, `not-${style.id}`) }, name)))));
            })),
        React__default["default"].createElement("g", { className: clsx(h.hasClick && `clickAble-${style.id}`) }, data.cs.v.map((c, i) => {
            return React__default["default"].createElement(KMapCell, { key: data.cs.keys[i], d: c, i: i, h: h, style: style, data: data });
        })),
        React__default["default"].createElement("g", { transform: `translate(${data.grid.x}, ${data.grid.y})` }, data.grid.levels.map((l, i) => (React__default["default"].createElement("path", { key: i, d: generateGridPath(data.cell, data.grid.vCells, data.grid.hCells, l), className: `gridStyle-${style.id} gridStyle-${style.id}-${i}` }))))));
});
...
function KMapQueries$1({ data, style, elemOverlap, secondary, tooltip, suffix, empty, }) {
    ...
    const className = clsx(`fill${suffix}`, !tooltip && `pnone-${style.id}`, style.classNames.bar);
    return (React__default["default"].createElement("g", { "data-upset": secondary ? 'cs-q' : 'cs-s' }, data.cs.v.map((d, i) => {
        const l = data.cs.l[i];
        const key = data.cs.keys[i];
        if (empty && !secondary) {
            return (React__default["default"].createElement("rect", { key: key, x: l.x + offset, y: l.y + data.cell, height: 0, width: width, className: className, style: mergeColor(style.styles.bar, !style.selectionColor ? d.color : undefined) }, tooltip && React__default["default"].createElement("title", null)));
        }
        const o = elemOverlap(d);
        if (o === 0) {
            return null;
        ...
        const title = tooltip && React__default["default"].createElement("title", null, `${d.name} ∩ ${tooltip}: ${o}`);
        return secondary ? (React__default["default"].createElement("path", { key: key, transform: `translate(${l.x + offset}, ${l.y + y})`, d: `M0,-1 l${width},0 l0,2 l${-width},0 L-${data.triangleSize},-${data.triangleSize} L-${data.triangleSize},${data.triangleSize} Z`, className: className, "data-i": i, "data-cardinality": o, style: mergeColor(undefined, !style.selectionColor ? d.color : undefined) }, title)) : (React__default["default"].createElement("rect", { key: key, x: l.x + offset, y: l.y + y, height: data.cell - y, "data-i": i, "data-cardinality": o, width: width, className: className, style: mergeColor(style.styles.bar, !style.selectionColor ? d.color : undefined) }, title));
    })));
}
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const KMapQueries = /*!#__PURE__*/ React__default["default"].memo(function KMapQueries({ data, style, hasHover, secondary, queries, }) {
    const qs = React.useMemo(() => queries.map((q) => (Object.assign(Object.assign({}, q), { overlap: model.queryOverlap(q, 'intersection', data.toElemKey) }))), [queries, data.toElemKey]);
    return (React__default["default"].createElement("g", { className: hasHover && !secondary ? `pnone-${style.id}` : undefined }, qs.map((q, i) => (React__default["default"].createElement(KMapQueries$1, { key: q.name, data: data, style: style, elemOverlap: q.overlap, suffix: `Q${i}-${data.id}`, secondary: secondary || i > 0, tooltip: hasHover && !(secondary || i > 0) ? undefined : q.name })))));
});
...
function KMapSelection({ data, style, selection, hasHover, }) {
    ...
    const selectionOverlap = generateSelectionOverlap(selection, data.overlapGuesser, data.toElemKey);
    const selectionName = generateSelectionName(selection);
    return (React__default["default"].createElement("g", { className: hasHover ? `pnone-${style.id}` : undefined }, (selection || empty) && (React__default["default"].createElement(KMapQueries$1, { data: data, style: style, empty: empty && !selection, elemOverlap: selectionOverlap, suffix: `Selection-${style.id}`, tooltip: hasHover ? undefined : selectionName }))));
}
...
function deriveKarnaughDataDependent(sets, combinations, size, numericScale, barLabelFontSize, barPadding, setLabelFontSize, tickFontSize, toKey, toElemKey, id, combinationMaxScale) {
    ...
    const cs = areCombinations(combinations)
        ? combinations
        : model.generateCombinations(sets, Object.assign({
            type: 'distinctIntersection',
 ...
 * Copyright (c) 2021 Samuel Gratzl <sam@sgratzl.com>
 */
const KarnaughMap = /*!#__PURE__*/ React__default["default"].forwardRef(function KarnaughMap(props, ref) {
    ...
    const style = React.useMemo(() => deriveStyleDependent(p.theme, p.styles, p.classNames, p.combinationName, p.combinationNameAxisOffset, styleId, p.barLabelOffset, p.selectionColor, p.emptySelection, p.title, p.description, p.tooltips), [
        p.theme,
        p.styles,
        p.classNames,
        p.combinationName,
    ...
    const size = React.useMemo(() => deriveVennSizeDependent(p.width, p.height, p.padding, p.id), [p.width, p.height, p.padding, p.id]);
    const data = React.useMemo(() => deriveKarnaughDataDependent(p.sets, p.combinations, size, p.numericScale, p.barLabelOffset + parseFontSize(fontSizes.barLabel), p.barPadding, parseFontSize(fontSizes.setLabel), parseFontSize(fontSizes.axisTick), p.toKey, p.toElemKey, p.id, p.combinationMaxScale), [
        p.sets,
        p.combinations,
        size,
        p.numericScale,
  ...
  `;
    ...
    return (React__default["default"].createElement(SVGWrapper, { rules: rules, style: style, size: size, p: p, data: data, tRef: ref, selectionName: selectionName, h: h, exportChart: exportChart },
        React__default["default"].createElement(UpSetTitle, { style: style, width: maxWidth }),
        React__default["default"].createElement(KMapChart, { style: style, data: data, h: h, size: size }),
        React__default["default"].createElement(KMapSelection, { style: style, data: data, hasHover: h.hasHover, selection: selection }),
        React__default["default"].createElement(KMapQueries, { style: style, data: data, hasHover: h.hasHover, queries: queries, secondary: h.hasHover || selection != null })));
});
 ...
 * with React.forwardRef support to specify a reference to the SVG element
 */
const UpSetJSSkeleton = /*!#__PURE__*/ React__default["default"].memo(
/*!#__PURE__*/ React__default["default"].forwardRef(function UpSetJSSkeleton(props, ref) {
    ...
    return (React__default["default"].createElement("svg", Object.assign({ viewBox: "0 0 300 200", ref: ref }, rest),
        cOffsets.map((offset, i) => (React__default["default"].createElement("rect", { key: i, x: csX + i * (wi + padding), y: offset, width: wi, height: cHeight - offset, fill: color }))),
        sOffsets.map((offset, i) => (React__default["default"].createElement("rect", { key: i, x: offset, y: sY + i * (wi + padding), width: sWidth - offset, height: wi, fill: color }))),
        cOffsets.map((_, i) => sOffsets.map((_, j) => {
            const filled = j === 2 - i || (i === 3 && j > 0) || (i === 4 && j !== 1) || (i === 5 && j < 2) || i === 6;
            return (React__default["default"].createElement("circle", { key: `${i}x${j}`, cx: csX + i * (wi + padding) + wi / 2, cy: sY + j * (wi + padding) + wi / 2, r: wi / 2, fill: filled ? color : secondary }));
        })),
        React__default["default"].createElement("rect", { x: "182", y: "150", width: "6", height: "30", fill: color }),
        React__default["default"].createElement("rect", { x: "212", y: "120", width: "6", height: "60", fill: color }),
        React__default["default"].createElement("rect", { x: "242", y: "120", width: "6", height: "30", fill: color }),
        React__default["default"].createElement("rect", { x: "272", y: "120", width: "6", height: "60", fill: color })));
}));
 ...
 * with React.forwardRef support to specify a reference to the SVG element
 */
const VennDiagramSkeleton = /*!#__PURE__*/ React__default["default"].memo(
/*!#__PURE__*/ React__default["default"].forwardRef(function VennDiagramSkeleton(props, ref) {
    const { color, secondary, rest } = prepare(props);
    const padding = 10;
    const l = layoutImpl(3, 300 - padding * 2, 3200 - padding * 2);
    return (React__default["default"].createElement("svg", Object.assign({ viewBox: "0 0 300 200", ref: ref }, rest),
        l.sets.map((set, i) => (React__default["default"].createElement("circle", { key: i, cx: set.cx, cy: set.cy + padding, r: set.r, fill: secondary }))),
        l.sets.map((set, i) => (React__default["default"].createElement("circle", { key: i, cx: set.cx, cy: set.cy + padding, r: set.r, stroke: color, fill: "none" })))));
}));
 ...
 * with React.forwardRef support to specify a reference to the SVG element
 */
const KarnaughMapSkeleton = /*!#__PURE__*/ React__default["default"].memo(
/*!#__PURE__*/ React__default["default"].forwardRef(function KarnaughMapSkeleton(props, ref) {
    ...
    const v3 = 0.26;
    const v4 = 0.75;
    return (React__default["default"].createElement("svg", Object.assign({ viewBox: "0 0 300 200", ref: ref, fontFamily: "sans-serif" }, rest),
        React__default["default"].createElement("g", { transform: `translate(${xBefore + 10},${yBefore + 10})` },
            React__default["default"].createElement("text", { x: cell * 0.5, y: -3, fill: color, textAnchor: "middle" }, "A"),
            React__default["default"].createElement("text", { x: cell * 1.5, y: -3, fill: color, textAnchor: "middle", style: { textDecoration: 'overline' } }, "A"),
            React__default["default"].createElement("text", { x: -3, y: cell * 0.5, fill: color, textAnchor: "end", dominantBaseline: "central" }, "B"),
            React__default["default"].createElement("text", { x: -3, y: cell * 1.5, fill: color, textAnchor: "end", dominantBaseline: "central", style: { textDecoration: 'overline' } }, "B"),
            React__default["default"].createElement("rect", { x: cell * 0.1, y: cell * (1 - v1), height: cell * v1, width: cell * 0.8, fill: secondary }),
            React__default["default"].createElement("rect", { x: cell * 1.1, y: cell * (1 - v2), height: cell * v2, width: cell * 0.8, fill: secondary }),
            React__default["default"].createElement("rect", { x: cell * 0.1, y: cell * (1 - v3 + 1), height: cell * v3, width: cell * 0.8, fill: secondary }),
            React__default["default"].createElement("rect", { x: cell * 1.1, y: cell * (1 - v4 + 1), height: cell * v4, width: cell * 0.8, fill: secondary }),
            React__default["default"].createElement("path", { d: `M0,0 l${gw},0 l0,${gh} l${-gw},0 l0,${-gh} M${gw / 2},0 l0,${gh} M0,${gh / 2} l${gw},0`, fill: "none", stroke: color }))));
}));
...
function sets(value) {
    return Array.isArray(value) && value.every(model.isSet);
}
function combinations(value) {
    return (value == null || (Array.isArray(value) && value.every(model.isSetCombination)) || model.isGenerateSetCombinationOptions(value));
}
function selection(value) {
    return value == null || Array.isArray(value) || model.isSetLike(value);
}
...
function queries(value) {
    return !value || (Array.isArray(value) && value.every(model.isUpSetQuery));
}
...
exports.KarnaughMap = KarnaughMap;
exports.KarnaughMapSkeleton = KarnaughMapSkeleton;
exports.UpSetJS = UpSetJS;
exports.UpSetJSSkeleton = UpSetJSSkeleton;
exports.VennDiagram = VennDiagram;
exports.VennDiagramSkeleton = VennDiagramSkeleton;
exports.createVennJSAdapter = createVennJSAdapter;
exports["default"] = UpSetJS;
exports.downloadUrl = downloadUrl;
exports.exportSVG = exportSVG;
exports.exportVegaLite = exportVegaLite;
exports.fillDefaults = fillDefaults;
exports.fillDefaultsG = fillDefaultsG;
exports.fillKarnaughMapDefaults = fillKarnaughMapDefaults;
exports.fillKarnaughMapDefaultsG = fillKarnaughMapDefaultsG;
exports.fillVennDiagramDefaults = fillVennDiagramDefaults;
exports.fillVennDiagramDefaultsG = fillVennDiagramDefaultsG;
